...
module.exports = {
    ...
    'test .parseComments() tags contains parameter description': function (done) {
				fixture('descriptions.js', function (err, str){
						var tags = dox.parseComments(str)[0].tags;
						tags[0].name.should.equal("method");
						tags[0].description.should.equal("a method");
						tags[1].name.should.equal("list");
						tags[1].description.should.equal("a list");
						tags[2].name.should.equal("object")
						tags[2].description.should.equal("an object");
						should(tags[3].name).be.undefined;
						tags[3].description.should.equal("error on Error");
						should(tags[4].name).be.undefined;
						tags[4].description.should.equal("true if ok");
						done();
				});
    },
